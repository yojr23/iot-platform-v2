...
- **GATE 10 — backend blockers RESOLVED, not yet CLOSED (2026-09-11).** Backend CI green (0 failed, 0 skipped); 26 CDC/domain-event tests run on real Redis; G10-PUB-08 green; CI now provisions Redis. Outstanding: live-Docker CDC failure matrix (Scenarios A–E) + `network-assertion-live.mjs`. See `docs/implementation/gate-10-evidence.md`.
