...
| Live Gate 9/10 evidence | P0 | ⚠️ PARTIAL (2026-09-17) | Now done: **live 60s no-polling browser capture PASS**, poison→DLQ (live), ingestion HTTP tier (live), durable self-contained reading event, MySQL EXPLAIN, dependency audit, MySQL mapping concurrency. Still open: Redis/Debezium restart, XAUTOCLAIM, full MQTT→browser trace, desktop/mobile visual QA, branch protection. See 2026-09-17 reconciliation. |
